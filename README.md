...
- The ERP repo (`erp-saas`): `erp-saas:docs/OVERVIEW.md` (start here: the product, how everything links, the editor
  sync in §6.6) and `erp-saas:CLAUDE.md`. The integration architecture is
