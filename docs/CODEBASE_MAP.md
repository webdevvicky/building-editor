...
For phase history and deep dives, see `docs/reference/CLAUDE-phase-history.md` and `docs/reference/CLAUDE-boq-reference.md`. Architectural rules live in the root `CLAUDE.md`.
